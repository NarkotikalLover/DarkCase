...
<div class="lnav" >
			...
			<a data-modal="#siteFree" href="#" style="margin-right: 4px; color: #FF0000">халява</a>
			<a data-modal="#siteFAQ" href="#">помощь</a>
			<!-- <a data-modal="#siteGuarantee" href="#" style="margin-right: 4px;">ГАРАНТИИ</a>-->
			</div>
	...
	</div>	<div class="stone containero" style="padding: 15px 10px; margin-bottom: -10px; height: 200px;">
	<div style="font-size: 24px; color: #F7F7F7; text-align: center; text-transform: uppercase; padding-bottom: 12.5px; font-weight: bold; line-height: 21px;">
	Последние выигрыши<br>
	<span style="font-size: 17px; font-weight: normal; text-transform: lowercase; letter-spacing: 1px;">В прямом эфире</span>
	</div>
	<div id="lastWinners"><?include($_SERVER["DOCUMENT_ROOT"].'/ajax/index_lastorders.php');
...
<div class="item-wrapper small" style="display:<?if($case["Operation Phoenix"]["open"] !== "true")echo "none"?>;">
	<div class="item" data-key="Operation Phoenix" data-price="<?echo $case["Operation Phoenix"]["price"];?>">
		<div class="desc">
			<div class="name">
				Cлучайное оружие из<br>
				<span>Кейс операции "Феникс"</span>
			</div>
		</div>
...
text-align: center;">
	...
	Акция! 50% от каждого платежа вашего реферала! Подробнее <a data-modal="#siteFree" href="#" style="color: #EFDA08;">здесь.</a></a>
	</div>
	Делитесь выигрышем в нашей группе ВК <a data-modal="#contacts" href="#" style="color: #EFDA08;">здесь.</a><br>
<span style="color: #EFDA08;">ВНИМАНИЕ!</span> Steam ввел новые ограничения, поэтому сейчас <br>действуют новые условия покупки. <a style="color: #EFDA08; cursor: pointer; text-decoration: underline;" data-modal="#rules">Ознакомиться с новыми условиями</a>
	...
	<div style="padding-top: 5px;">
	Комментарии временно отключены из-за спама.</a>
	</div>
...
<div id="siteFree" class="itemmodal" style="width: 660px; position: relative; padding: 20px; border-radius: 6px; border: 1px solid #4F3D18; display: inline-block;">
	...
	<div style="text-align: center; color: #D3A22C; font-weight: bold; font-size: 20px; text-transform: uppercase; padding-bottom: 5px;">Хочу открывать бесплатно</div>
	<hr class="style-two">
	<div style="font-size: 14px; line-height: 20px; color:#EAEAEA; padding-bottom: 3px;">
	<div style="margin-bottom: 10px;" id="accordion" role="tablist" aria-multiselectable=""true"">
			<div style="margin-top: 15px;">
				<div class="collapsetitle" role="tab" id="headingOne">
					<h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion" href="#A1">Как бесплатно пополнить счет?</a></h4>
				</div>
				<div id="A1" class="panel-collapse collapse in">
					<div style="padding: 10px 10px 0px 15px;">
						<?echo $_SERVER["HTTP_HOST"];?> представляет возможность заработка внутрисервисной валюты с помощью распространения реферальной ссылки. Иными словами: вы размещаете свою реферальную ссылку на сайтах/пабликах, тем самым получая деньги на счет.<br>
					</div>
				</div>
			</div>
			<div style="margin-top: 15px;">
				<div class="collapsetitle" role="tab" id="headingTwo">
					<h4 class="panel-title"><a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#A2">Как это работает?</a></h4>
				</div>
				<div id="A2" class="panel-collapse collapse">
					<div style="padding: 10px 10px 0px 15px;">
						<span style="font-size: 16px; color:#D3A22C; font-weight: bold;">1.</span> Авторизируйтесь на сайте удобным для вас способом (VK или Steam)
						<div style="padding-left: 17px; padding-top: 2px; font-size: 12px; line-height: 13px;">(!вы проходите авторизацию именно через сайты Вконтакте или Steam, никаких персональных данных от вас при авторизации мы не получаем!);</div>
						<span style="font-size: 16px; color:#D3A22C; font-weight: bold;">2.</span> Найдите в меню "Пополнить" вашу реферальную ссылку;
						<br><span style="font-size: 16px; color:#D3A22C; font-weight: bold;">3.</span> Скопируйте ее и вставляйте на популярных сайтах/пабликах;
						<br><span style="font-size: 16px; color:#D3A22C; font-weight: bold;">4.</span> Сайты будут представлены ниже;
						<br><span style="font-size: 16px; color:#D3A22C; font-weight: bold;">5.</span> Как только пользователь, перешедший по вашей ссылке, пополнит счет на любую сумму, вы получите бонус в размере 50%(!) от его суммы.
					</div>
				</div>
			</div>
			<div style="margin-top: 15px;">
				<div class="collapsetitle" role="tab" id="headingThree">
					<h4 class="panel-title"><a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#A3">Список сайтов</a></h4>
				</div>
				<div id="A3" class="panel-collapse collapse">
					<div style="padding: 10px 10px 0px 15px;">
						<br><span style="font-size: 16px; color:#D3A22C; font-weight: bold;">1.</span> <a href="http://csgo-random.com/" target="_blank">http://csgo-random.com/</a></br>
						<br><span style="font-size: 16px; color:#D3A22C; font-weight: bold;">2.</span> <a href="http://countershop.ru/" target="_blank">http://countershop.ru/</a></br>
						<br><span style="font-size: 16px; color:#D3A22C; font-weight: bold;">3.</span> <a href="http://all4csgo.com/" target="_blank">http://all4csgo.com/</a></br>
						<br><span style="font-size: 16px; color:#D3A22C; font-weight: bold;">4.</span> <a href="http://csgo.ms/" target="_blank">http://csgo.ms/</a></br>
						<br><span style="font-size: 16px; color:#D3A22C; font-weight: bold;">5.</span> <a href="http://csgokit.net/" target="_blank">http://csgokit.net/</a></br>
						<br><span style="font-size: 16px; color:#D3A22C; font-weight: bold;">6.</span> <a href="http://items-cs.ru/" target="_blank">http://items-cs.ru/</a></br>
						<br><span style="font-size: 16px; color:#D3A22C; font-weight: bold;">7.</span> <a href="http://storedota2.ru/" target="_blank">http://storedota2.ru/</a></br>
						<br><span style="font-size: 16px; color:#D3A22C; font-weight: bold;">8.</span> <a href="http://csgo-loto.ru/" target="_blank">http://csgo-loto.ru/</a></br>
						<br><span style="font-size: 16px; color:#D3A22C; font-weight: bold;">9.</span> <a href="http://cs-go-randoms.ru/" target="_blank">http://cs-go-randoms.ru/</a></br>
						<br><span style="font-size: 16px; color:#D3A22C; font-weight: bold;">10.</span> <a href="http://random-cs-go.ru/" target="_blank">http://random-cs-go.ru/</a></br>
						<br><span style="font-size: 16px; color:#D3A22C; font-weight: bold;">11.</span> <a href="http://gocs.pro/" target="_blank">http://gocs.pro/</a></br>
						<br><span style="font-size: 16px; color:#D3A22C; font-weight: bold;">12.</span> <a href="http://krabstore.ru/" target="_blank">http://krabstore.ru/</a></br>
						<br><span style="font-size: 16px; color:#D3A22C; font-weight: bold;">13.</span> <a href="http://randomcsgomarket.com/" target="_blank">http://randomcsgomarket.com/</a></br>
						<br><span style="font-size: 16px; color:#D3A22C; font-weight: bold;">14.</span> <a href="http://skins4game.ru/" target="_blank">http://skins4game.ru/</a></br>
						<br><span style="font-size: 16px; color:#D3A22C; font-weight: bold;">15.</span> <a href="http://sigmedbuy.net/otzyvy/index.htm" target="_blank">http://sigmedbuy.net/</a></br>
					</div>
				</div>
			</div>
			<div style="margin-top: 15px;">
				<div class="collapsetitle" role="tab" id="headingThree">
					<h4 class="panel-title"><a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#A4">Прочее</a></h4>
				</div>
				<div id="A4" class="panel-collapse collapse">
					<div style="padding: 10px 10px 0px 15px;">
						Текст вы можете придумать сами. Самый лучший пиарщик получит приз в размере 1000 рублей на сайте. Итоги в конце каждого месяца.
					</div>
				</div>
			</div>
	</div>
